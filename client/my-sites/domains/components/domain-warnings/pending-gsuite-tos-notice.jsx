...
class PendingGSuiteTosNotice extends React.PureComponent {
	...
	domainStatusNotice() {
		...
		return (
			<>
				<p>
					{ translate(
						'Your new user {{strong}}%(emails)s{{/strong}} is ready! Complete the setup in order to activate it.',
						'Your new users {{strong}}%(emails)s{{/strong}} are ready! Complete the setup in order to activate them.',
						{
							count: users.length,
							args: { emails },
							comment:
	...
	oneDomainNotice() {
		...
		return (
			<Notice
				...
				text={ translate(
					'%(exclamation)s Finish the setup of {{strong}}%(emails)s{{/strong}} in order to activate it.',
					'%(exclamation)s Finish the setup of {{strong}}%(emails)s{{/strong}} in order to activate them.',
					{
						count: users.length,
	...
	multipleDomainsNotice() {
		...
		return (
			...
			>
				{ translate(
					'%(exclamation)s Finish the setup of your new users in order to activate them:',
					{
						args: { exclamation },
					}
				) }
